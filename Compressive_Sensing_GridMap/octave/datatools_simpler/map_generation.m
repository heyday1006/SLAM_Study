%% Map Generation
function map = map_generation(mapFlag)
    if nargin < 1
        mapFlag = 2;
    end
    switch mapFlag
        case 0
            ...
            map = zeros(4,4);
            map(:,1) = [20; 20; 200; 20];
            map(:,2) = [200; 20; 200; 240];
            map(:,3) = [200; 240; 20; 240];
            map(:,4) = [20; 240; 20; 20];
        case 1
            % simple square in addition to a square interior
            map = zeros(4,8);
            % exterior
            map(:,1) = [20; 20; 200; 20];
            map(:,2) = [200; 20; 200; 240];
            ...
            % interior
            map(:,5) = [50; 50; 150; 50];
            map(:,6) = [150; 20; 150; 190];
            map(:,7) = [150; 190; 50; 190];
            map(:,8) = [50; 190; 50; 50];
        case 2
